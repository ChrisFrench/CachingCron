...
class CachingcronModelTools extends CachingcronModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'cachingcron'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh)) 
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_cachingcron&view=tools&task=view&id='.$item->id;
		    }		    
		} 
