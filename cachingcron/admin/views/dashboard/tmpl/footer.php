<?php defined('_JEXEC') or die('Restricted access'); ?>
	...
	<tr>
		...
		<td style="text-align: center; width: 33%;">
			<?php echo JText::_( "Cachingcron" ); ?>: <?php echo JText::_( "CACHINGCRON_DESC" ); ?>
			<br/>
			<?php echo JText::_( "Copyright" ); ?>: <?php echo Cachingcron::getInstance()->getCopyrightYear(); ?> &copy; <a href="<?php echo $url; ?>" target="_blank">Dioscouri Design</a>
			<br/>
			<?php echo JText::_( "Version" ); ?>: <?php echo Cachingcron::getInstance()->getVersion(); ?>
		</td>
