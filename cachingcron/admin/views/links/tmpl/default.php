		...
		<thead>
            <tr>
                ...
                <th style="text-align: left;width: 50%">
                	<?php echo DSCGrid::sort( 'Link Name', "tbl.name", @$state->direction, @$state->order ); ?>
                </th>
                 <th style="text-align: left;width: 50%">
                ...
                <th style="width: 100px;">
                 ...
                 <th style="width: 100px;">
    	            <?php echo DSCGrid::sort( 'Last Cron', "tbl.lastcroned", @$state->direction, @$state->order ); ?>
